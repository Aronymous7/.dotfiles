...
sudo apt install alsa-utils arandr arc-theme build-essential cups curl dunst exuberant-ctags firefox-esr flameshot fonts-inconsolata git gsimplecal htop i3lock imagemagick lxappearance neofetch network-manager nitrogen nomacs okular pandoc simple-scan suckless-tools sxhkd syncthing texlive-full thunderbird tldr tmux tmuxinator udevil unclutter unzip vifm vim vim-gui-common vlc xbacklight xclip xinput xmobar xmonad xorg xss-lock
